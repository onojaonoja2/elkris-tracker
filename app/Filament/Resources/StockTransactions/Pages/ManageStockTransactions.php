...
class ManageStockTransactions extends ManageRecords
{
    ...
    {
        return [
            \Filament\Actions\Action::make('export_stock_report')
                ...
                ->action(function (\Filament\Actions\Action $action) {
                    ...
                    $transactionsQuery = \App\Models\StockTransaction::query();
                    $deliveredQuery = \App\Models\Product::whereHas('order', function ($q) {
